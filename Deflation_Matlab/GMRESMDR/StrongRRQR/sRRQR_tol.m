function [Q, R, p] = sRRQR_tol(A, f, tol)
%
...
%           Q = Q1, 
%           R = [R11, R12];
%       where each column of R22 is less than tol. 
%
%   Reference: 
...
%   check a sufficiently large rank k to meet the threshold 'tol'
k = [];
if (size(R,1) == 1 || size(R,2) == 1)
    if (R(1,1) > tol) 
        k = 1; 
