  function [t,u]=Runge_Kutta4_Filter(f,tspan,u0,N)
...
%   u(n+1,:)=u(n,:)+dt*f(t(n),u(n,:));
      ...
      k1= dt*f(tspan(1),t(n),u(n,:));
      k2= dt*f(tspan(1),t(n)+dt/2,u(n,:) + k1/2);
      k3= dt*f(tspan(1),t(n)+dt/2,u(n,:) + k2/2);
      k4= dt*f(tspan(1),t(n)+dt,u(n,:) + k3);
