function [P_k,Y_k,C_k,U_k,resvec] = DeflationNDsvd(A,b,matrices,matInd,methodInd,methodDef,resvec,adaptive_deflation,V,H,npes,k,cycle,maxit,maxcycle,x_0,x_1,r_0,maxdef,tol,method)
