...
function [U_k,Sigma_k,V_k,V] = NDQRCPSingularValuesApproximationwithJacobiPr(A,b,Pr,begin_in,end_in,npes,k,maxit)
...
[~,last_k_columns_matrix_i]=ismember(BB(:,P_BB(end-k+1:end)).',A0.','rows');
