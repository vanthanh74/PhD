...
matrix='crystk03.mtx';  %sherman3 N=5005 nz=20033,  bcsstm25 bcsstk35  saylr4 lshp3466 CurlCurl_0 crystk03.mtx ct20stif.mtx bcsstm39.mtx
A =  mmread(matrix);
...
% A0 =  mmread(matrix);
MinvA = defpreconditioner(Q2,R22,A);%;%(I-Q2*Q2' +  Q2*(R22^-1)*Q2')*A;%
