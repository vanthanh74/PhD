...
% Pr_BIGP0 = 'lshp1009.mtx'; %N=1009 nz=23896
% Pr_BIGP0 = 'lshp3466.mtx'; %N=3466 nz=23896
% Pr_BIGP0 = 'bcsstk35.mtx'; %N=30237  nz=1450163
% Pr_BIGP0='CurlCurl_0.mtx';  %N=11083  
...
%                 size(H) size(A1)
                ...
                P_k = NDQRCPSingularValuesApproximation(A,npes,k);
...
%                 [~, indices] = sort(diag(Eig));
                ...
                P_k = NDQRCPSingularValuesApproximation(A1,npes,k);                 
