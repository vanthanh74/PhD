...
matrix='crystk03.mtx';  %sherman3 N=5005 nz=20033,  bcsstk35 saylr4 lshp3466 CurlCurl_0 crystk03.mtx ct20stif.mtx bcsstm39.mtx
A =  mmread(matrix);
...
%------------------------------------------------------------------
% % M^-1 * A
MinvA = defpreconditioner(Q2,R22,A);
s=svd(MinvA);
s_k = s(end-k+1:end);
%------------------------------------------------------------------
% % (M_1^-1 + M_2^-1) * A
...
dd=1
compare_mat=[sA_k sR22_k s_k s_k1 s_k2]
