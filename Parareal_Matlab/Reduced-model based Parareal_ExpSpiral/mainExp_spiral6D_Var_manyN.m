...
G=@(t0,t1,u0) SGRunge_Kutta4_Exp_spiral_6D(fG,t0,t1,u0,MG); %  Limit model coarse solver G coarse solver G
...
% legendTitle = cell(1,iter_refine);

% leg{k} = ['L^{\infty}error with N = ',num2str(N_vec(1))];
