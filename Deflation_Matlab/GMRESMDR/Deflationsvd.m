function [P_k,Y_k,C_k,U_k,resvec] = Deflationsvd(A,b,matInd,methodInd,methodDef,resvec,adaptive_deflation,V,H,k,cycle,maxit,maxcycle,x_0,x_1,r_0,maxdef,tol,method)
